  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Emergency calls include a service fee plus materials and labor. While emergency services may cost slightly more due to after-hours response, we keep pricing fair and transparent. Insurance often covers emergency glass repairs.',
      },
    ],
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {faqs.map((category, ci) => (
            <AnimateOnScroll key={ci} delay={ci * 60}>
        ...
        <AnimateOnScroll from="scale" className="max-w-2xl mx-auto mt-12">
